...
#ifndef SDK2013CE // See ai_grenade.h
...
#ifndef SDK2013CE // Now that we use WeaponSound(SPECIAL1), this isn't necessary
...
{
#ifndef SDK2013CE // Moved to SelectSchedule()
	// Drop a grenade?
	if ( HasCondition( COND_COMBINE_DROP_GRENADE ) )
		return SCHED_COMBINE_DROP_GRENADE;
#endif
...
#ifndef SDK2013CE // CAI_GrenadeUser
