...
#ifdef SDK2013CE
ConVar weapon_crossbow_new_hit_locations( "weapon_crossbow_new_hit_locations", "0", FCVAR_NONE, "Toggles new crossbow knockback that properly pushes back the correct limbs." );
#endif
